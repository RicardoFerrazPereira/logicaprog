programa
{
	...
	funcao inicio()
	{
		real valorkg, totalgramas, cemgramas, pesocons, valortotal, gramas, pesoliq
		real tara = 0.465
		...
		cemgramas = valorkg / 100
		pesoliq = gramas / 1000 - tara 
		valortotal = valorkg * pesoliq
		
		escreva("\n", "Restaurante Self-Service", "\n", "\n")		
		escreva("Peso do prato: ",tara, " ", "kg", "\n")
		escreva("Valor de 100 gramas: R$", " ", cemgramas, "\n")
		escreva("Peso Consumido: ", pesoliq, " ", "kg", " ", "\n")
